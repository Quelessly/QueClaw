    ...
    <div style={{ background: '#050505', color: '#fff', overflowX: 'hidden', fontFamily: "'Syne', sans-serif" }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .b1{animation:flt1 3.2s ease-in-out infinite;}
        .b2{animation:flt2 4s ease-in-out infinite 0.4s;}
        ...
        .tab-inactive { background:transparent; color:#555; border:1px solid rgba(255,255,255,0.07); }
        ...
        @media(max-width:768px){
          ...
          .phone-wrap{order:-1;}
          .phone{width:160px;height:320px;border-radius:28px;}
          .b1,.b2{display:none;}
      ...
      <nav className="nav">
        ...
        <div style={{ display:'flex', gap:8, alignItems:'center' }}>
          ...
          <Link href="#order" className="btn-lime" style={{ padding:'7px 18px', fontSize:13 }}>Scan & Order</Link>
        </div>
      </nav>
      ...
      {activeOrder && (
        <div className="order-banner" style={{ position:'fixed', top:58, left:0, right:0, zIndex:49, padding:'8px 16px', background:'rgba(5,5,5,0.95)', borderBottom:'1px solid var(--lime-border)' }}>
          <button
            ...
            style={{ width:'100%', maxWidth:560, margin:'0 auto', display:'flex', alignItems:'center', justifyContent:'space-between', background:'var(--lime-dim)', border:'1px solid var(--lime-border)', borderRadius:12, padding:'9px 16px', cursor:'pointer' }}
          >
        ...
        <div className="hero-inner" style={{ maxWidth:1100, margin:'0 auto', width:'100%', display:'flex', alignItems:'center', justifyContent:'space-between', gap:48, paddingTop:58 }}>
          <div style={{ flex:'1 1 400px', maxWidth:540 }}>
            ...
            <h1 className="h1" style={{ fontSize:'clamp(44px,5.5vw,72px)', fontWeight:800, lineHeight:1.04, letterSpacing:'-2.5px', marginBottom:20 }}>
              Your canteen,<br />
              <span className="shimmer">instantly.</span>
            </h1>
            ...
            <div className="hero-btns" style={{ display:'flex', gap:10, flexWrap:'wrap' }}>
              <Link href="#order" className="btn-lime" style={{ fontSize:15, padding:'12px 26px' }}>Scan & Order →</Link>
              <Link href="#owners" className="btn-ghost" style={{ fontSize:15, padding:'12px 26px' }}>For business owners</Link>
            </div>
          </div>
      ...
      {/* CLOSING CTA */}
      <section id="order" style={{ padding:'120px 20px', textAlign:'center', position:'relative', overflow:'hidden' }}>
        ...
        <div id="cta" data-animate className={`fu ${v('cta')?'v':''}`}>
          ...
          <h2 className="big-h" style={{ fontSize:'clamp(38px,6vw,76px)', fontWeight:800, letterSpacing:'-3px', lineHeight:1.05, maxWidth:700, margin:'0 auto 36px' }}>
            ...
            <span style={{ color:'var(--lime)' }}>More time eating.</span>
          </h2>
          <div style={{ display:'flex', gap:12, justifyContent:'center', flexWrap:'wrap' }}>
            <Link href="/v/demo" className="btn-lime" style={{ fontSize:15, padding:'13px 28px' }}>Scan & Order →</Link>
            <a href="mailto:support@quelessly.com?subject=I want to join Quelessly" className="btn-ghost" style={{ fontSize:15, padding:'13px 28px' }}>Join as a business</a>
          </div>
        </div>
      </section>
